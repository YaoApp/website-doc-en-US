...
<Div style={{ display: 'flex', justifyContent: 'space-between' }}>
	<Link type='prev' title='Use Process' link='b.Basic%20Features/d.Use%20Process'></Link>
	<Link type='next' title='Query data' link='b.Basic%20Features/f.Query%20Data'></Link>
</Div>
