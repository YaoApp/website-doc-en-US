# Use YAO Widget to create a cloud table

70% of the functions of most business systems and management backgrounds are the addition, deletion, modification and checking of data tables. These functions are not technically difficult, just copy and paste to modify the fields. YAO provides a more elegant way of "copying and pasting". If you want to say goodbye to tedious repetitive work, **faster and better** to complete such function coding, or you need to **build your own set of cloud forms **System, the following content can help you.
...
![image.png](https://release-sv-1252011659.cos.na-siliconvalley.myqcloud.com/docs/%E6%95%99%E7%A8%8B/image.png)

![res.png](https://release-sv-1252011659.cos.na-siliconvalley.myqcloud.com/docs/%E6%95%99%E7%A8%8B/res.png)
...
### YAO open source application engine

![yao-arch-white.png](https://release-sv-1252011659.cos.na-siliconvalley.myqcloud.com/docs/%E6%95%99%E7%A8%8B/yao-arch- white.png)
YAO is an open source application engine, written in Golang, in the form of a command-line tool that can be downloaded and used immediately. It is suitable for building business systems, website/APP API interfaces, management background and other applications.

YAO adopts the flow-based programming mode, and realizes various functions by writing YAO DSL (Logical Description in JSON format) or JavaScript processor. The YAO DSL can be written in several ways:
...
**Official Documentation:** [https://yaoapps.com/doc](https://yaoapps.com/doc)
...
Reference Document [Getting Started Guide](../Introduction/Getting Started), install the YAO command (version: v0.10.1) locally, and be familiar with the basic usage.
...
Write the Export function, declare the processor to be exported, [View source](https://github.com/YaoApp/demo-widget/blob/main/widgets/dyform/process.js)
...
| ------------- | --------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------- |
| Model         | Convert dyform DSL to model DSL, which is equivalent to manually writing a xxx.mod.json DSL file in the models folder | [View source](https://github.com/YaoApp/demo-widget/blob/ main/widgets/dyform/process.js) |
| Table         | Convert dyform DSL to table DSL, which is equivalent to manually writing a xxx..json DSL file in the tables folder    | [View source](https://github.com/YaoApp/demo-widget/blob/main /widgets/dyform/process.js) |
...
| ------------------- | --------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- |
| Models              | Call the Model processor to export the Yao model widget, the data structure is {MODEL_NAME:String: Model_DSL:Object}  | [View source code](https://github.com/YaoApp/demo-widget/blob/main/widgets /dyform/export.js) |
| Tables              | Call the Table processor, export it as Yao table widget, the data structure is: {TABLE_NAME:String: Table_DSL:Object} | [View source code](https://github.com/YaoApp/demo-widget/blob/main /widgets/dyform/export.js) |
...
![demo.png](https://release-sv-1252011659.cos.na-siliconvalley.myqcloud.com/docs/%E6%95%99%E7%A8%8B/demo.png)
...
How to create and use data models models/template.mod.json and manage tables tables/template.tab.json, refer to [Model documentation](../Base%20Features/Create%20Data%20Model.mdx) and [Table Documentation](../Manual/Processor/Data%20Table)
...
![admin.png](https://release-sv-1252011659.cos.na-siliconvalley.myqcloud.com/docs/%E6%95%99%E7%A8%8B/admin.png)
...
![admin2.png](https://release-sv-1252011659.cos.na-siliconvalley.myqcloud.com/docs/%E6%95%99%E7%A8%8B/admin2.png)
![res.png](https://release-sv-1252011659.cos.na-siliconvalley.myqcloud.com/docs/%E6%95%99%E7%A8%8B/res-2.png)
...
![image.png](https://release-sv-1252011659.cos.na-siliconvalley.myqcloud.com/docs/%E6%95%99%E7%A8%8B/overview-4.png)
...
![image.png](https://release-sv-1252011659.cos.na-siliconvalley.myqcloud.com/docs/%E6%95%99%E7%A8%8B/overview-3.png)

## Part IV: Make a C-side form page

For C-side pages such as event registration and appointment registration, personalized design is required to improve user experience. for suchFor scenarios, a set of templates can be designed in a targeted manner and implemented using any front-end technology stack. Here is a demo of VUE3 implementation.
...
![image.png](https://release-sv-1252011659.cos.na-siliconvalley.myqcloud.com/docs/%E6%95%99%E7%A8%8B/overview.png)

Open `http://your-host:port/vue3/?form=dyform.instance_1` to access the custom form page
![image.png](https://release-sv-1252011659.cos.na-siliconvalley.myqcloud.com/docs/%E6%95%99%E7%A8%8B/overview-last.png)
