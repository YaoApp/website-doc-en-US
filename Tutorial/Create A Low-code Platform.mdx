...
YAO adopts the flow-based programming mode, and realizes various functions by writing YAO DSL (Logical Description in JSON format) or JavaScript process. The YAO DSL can be written in several ways:
...
Write the Export function, declare the process to be exported, [View source](https://github.com/YaoApp/demo-widget/blob/main/widgets/dyform/process.js)
...
How to create and use data models models/template.mod.json and manage tables tables/template.tab.json, refer to [Model documentation](../Base%20Features/Create%20Data%20Model.mdx) and [Table Documentation](../Manual/process/Data%20Table)
