...
<blockquote>
	<p>
		You can use JavaScript scripts to process the return values ​​of data flow nodes and
		return data structures as needed.
	</p>
</blockquote>
 ...
 * @param any out Data flow node processor or QueryDSL return value
...
A processor can be called using the `Process` function. Modify `find.format.js` to also return user information.
...
<Extend
	...
	desc='Learn how to set up relationships between models.'
	link='c. Advanced Features/a. Data Model Association'
></Extend>

<Div style={{ display: 'flex', justifyContent: 'space-between' }}>
	<Link type='prev' title='Query data' link='b. Basic features/f. Query data'></Link>
	<Link
		type='next'
		title='Data Model Association'
		link='c. Advanced Features/b. Data Model Association'
	></Link>
</Div>
