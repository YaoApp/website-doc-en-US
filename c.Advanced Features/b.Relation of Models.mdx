...
<blockquote>
	<strong>hasOne</strong> and <strong>hasMany</strong> supported between data models way to
	associate, query by <strong>withs</strong>
...
<Extend
	...
	desc='Learn how to write data model and query conditions for Query DSL.'
...
<Div style={{ display: 'flex', justifyContent: 'space-between' }}>
	<Link
		...
		link='c. Advanced features/a. Data flow using JS'
	></Link>
	<Link
		type='next'
		title='Complex data query'
