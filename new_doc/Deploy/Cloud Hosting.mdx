...
Refer to the [source code compilation](../expert/%E6%BA%90%E7%A0%81%E7%BC%96%E8%AF%91.mdx) document to compile the product. Copy the artifact to the /usr/bin/ directory and add executable permissions.
