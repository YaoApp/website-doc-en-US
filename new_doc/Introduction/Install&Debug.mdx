...
This chapter introduces how to set up the Yao development and debugging environment locally. For production use, please refer to the <a href="../deployment/introduction">deployment</a> document.
...
| ---------- | -------- | ----------------------------------------------------------------------------------------- |
| process    | is       | running processor name. [processor docs](../base/use_processor)                           |
| args...    | no       | A table of input arguments for the processor. [processor docs](../basic/using-processors) |
