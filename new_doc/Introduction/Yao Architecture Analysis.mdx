...
Based on the flow-based programming idea, YAO encapsulates a series of atomic operations into processors; these processors can be called in YAO DSL or JavaScript scripts.
...
App Engine Command Line Tool & Scenario-Specific Processor [Yao App Engine](https://github.com/yaoapp/yao)

### Gou Framework

Engine core logic & general processor [Gou Framework](https://github.com/yaoapp/gou)
...
[View source code compilation document](../Expert/%E6%BA%90%E7%A0%81%E7%BC%96%E8%AF%91.mdx)

## add handler

For some specific scenarios, you need to add a new processor to the engine, use the `gou.RegisterProcessHandler` method to register a Golang function as a processor.
...
func init() {
gou.RegisterProcessHandler("mycom.myprocesses.hello", processHello) // register the processor
}
