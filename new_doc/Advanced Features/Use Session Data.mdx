...
**Processor password verification logic:**
...
<Notice type="success">
  ...
  Split into two processors, the token issuance processor can be reused in scenarios
...
<Div style={{ display: "flex", justifyContent: "space-between" }}>
  <Link
    ...
    link="Advanced Features/Complex Data Query"
  ></Link>
  <Link type="next" title="Use Cache" link="Advanced Features/Use Cache"></Link>
</Div>
