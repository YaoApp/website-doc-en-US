...
<blockquote>
  ...
  <p>
    Use the data import component in Tables as a processor.
  </p>
  <p>
...
| ---------------------------------------------- | ------------------------------------------ |
| /api/xiang/import/<table name>/setting         | Get the Setting of the table               |
| /api/xiang/import/<table name>/mapping         | Get the mapping field of the table         |
| /api/xiang/import/<table name>/mapping/setting | Get the mapping field setting of the table |
| /api/xiang/import/<table name>/data            | Get data                                   |
| /api/xiang/import/<table name>/data/setting    | setting to get data                        |
| /api/xiang/import/<table name>                 | Import data interface                      |
