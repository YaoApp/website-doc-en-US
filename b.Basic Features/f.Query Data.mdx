...
<Extend
	...
	link='c. Advanced Features/b. Data Model Association Query'
></Extend>

<Extend
	title='Data Model Association'
	desc='Learn how to set up associations between data models and perform association queries.'
	link='c. Advanced Features/b. Data Model Association Query'
></Extend>

<Extend
	title='Data Model Process'
	desc='Learn more about data model manipulation handlers.'
	link='e. Process Reference/a. Data Model'
></Extend>
...
<Extend
	...
	link='c. Advanced Features/b. Complex Data Query'
></Extend>
...
<Extend
	...
	link='c. Advanced features/f. Data flow using JS'
></Extend>

<Div style={{ display: 'flex', justifyContent: 'space-between' }}>
	<Link type='prev' title='Write data flow' link='b. Basic features/e. Write data flow'></Link>
	<Link
		type='next'
		title='Data flow using JS'
		link='c. Advanced features/f. Data flow using JS'
