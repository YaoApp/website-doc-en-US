...
<Extend
	...
	link='e.API Reference/a.Data Model'
></Extend>
...
<Extend
	...
	link='b. Basic features/b. Writing interfaces'
></Extend>
...
<Div style={{ display: 'flex', justifyContent: 'space-between' }}>
	<Link
		...
		link='a.Introduction/b.Installation and debugging'
	></Link>
	<Link
		type='next'
		title='Write an interface'
		link='b. Basic features/b. Write an interface'
	></Link>
</Div>
