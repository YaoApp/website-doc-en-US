...
<Notice type='success'>
	Tip: Yao will automatically generate component associations based on the field types defined
	in the data model. as in `columns` Re-declaration in , will override the default associated
	component.
</Notice>

<Notice type='success'>
	Tip: The data model is not coupled with the data table. If you do not set the data model
...
<Notice type='success'>
	Tip: A model can be bound to multiple tables, and the component description associated with
...
<Extend
	...
	link='d.API Reference/j.DataTables'
></Extend>
...
<Extend
	...
	link='d.API Reference/h.Data Kanban'
></Extend>
...
<Extend
	...
	link='d.API Reference/h1.Analytics Chart'
></Extend>
...
<Extend
	title='Data screen'
	desc='Learn how to describe components related to analysis charts, processes, API interface input and output, etc.'
	link='d.API reference/h3.Data screen'
></Extend>
